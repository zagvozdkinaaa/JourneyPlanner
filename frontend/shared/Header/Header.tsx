...
export default function Header() {
  return (
    <>
      <div className="flex  p-[3%] lg:p-[1%]">
        <div className="flex  gap-[2%] basis-[80%] lg:basis-[53%] items-center ml-[3%] lg:ml-[8%]">
          <MapPin
            size={35}
            className="text-white bg-gradient-to-br from-sky-500 to-emerald-600 p-[1%] rounded-[0.5rem]"
          />
        ...
        <div className="flex hidden lg:flex gap-[1%] justify-start  basis-[45%] text-gray-600">
          <div className="flex items-center gap-[6%] basis-[17%] p-[1%]  hover:bg-sky-50 hover:text-sky-700 rounded-[0.5rem] justify-center">
            <Home size={18} />
          ...
          <div className="flex flex items-center basis-[17%] p-[1%] gap-[6%] hover:bg-sky-50 hover:text-sky-700 rounded-[0.5rem] justify-center">
            <User size={18} />
            <button className="text-[1.1rem] font-semibold  hover:text-sky-600">
              Profile
            </button>
